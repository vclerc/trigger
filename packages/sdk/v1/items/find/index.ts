...
// @ts-ignore
import { createHighOrderQueryDTOFromDiscriminatorValue, createItemDtoFromDiscriminatorValue, createLowOrderQueryDTOFromDiscriminatorValue, deserializeIntoHighOrderQueryDTO, deserializeIntoLowOrderQueryDTO, serializeHighOrderQueryDTO, serializeItemDto, serializeLowOrderQueryDTO, type HighOrderQueryDTO, type ItemDto, type LowOrderQueryDTO } from '../../../models/index.js';
// @ts-ignore
 ...
 */
export const FindRequestBuilderUriTemplate = "{+baseurl}/v1/items/find?partitionId={partitionId}{&page*,size*}";
