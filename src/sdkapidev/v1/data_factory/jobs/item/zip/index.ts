...
// @ts-ignore
import { createJobDtoFromDiscriminatorValue, serializeFileUploadDto, serializeJobDto, type FileUploadDto, type JobDto } from '../../../../../models/index.js';
// @ts-ignore
...
export interface ZipRequestBuilder extends BaseRequestBuilder<ZipRequestBuilder> {
     ...
     */
     put(body: FileUploadDto, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<JobDto | undefined>;
    /**
     * Upload a zip to update a job
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPutRequestInformation(body: FileUploadDto, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
