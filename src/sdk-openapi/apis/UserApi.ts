...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param page 
     */
    public async findUsers(queryDTO: QueryDTO, size?: number, page?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'queryDTO' is not null or undefined
        if (queryDTO === null || queryDTO === undefined) {
            throw new RequiredError("UserApi", "findUsers", "queryDTO");
        }
        ...
        // Path Params
        const localVarPath = '/v1/users/find';
     ...
     * @param id 
     */
    public async getUserById(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param page 
     */
    public async getUsers(size?: number, page?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class UserApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to findUsers
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async findUsersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetUsers200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetUsers200Response = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUsersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetUsers200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetUsers200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
