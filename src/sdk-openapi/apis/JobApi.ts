...
export class JobApiResponseProcessor {
     ...
     */
     public async createJobWithHttpInfo(response: ResponseContext): Promise<HttpInfo<JobDto >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getJobByIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<JobDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getJobsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetJobs200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateJobWithHttpInfo(response: ResponseContext): Promise<HttpInfo<JobDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: JobDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateJobZipWithHttpInfo(response: ResponseContext): Promise<HttpInfo<JobDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: JobDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
